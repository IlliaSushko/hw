...
//     this.authorName = document.createElement('div');
//     this.authorText = document.createElement('div');
//     li.id = comment.id;
...
// assyncTimeOut(2000).then(() => console.log('Hello world')).catch(console.log(1));